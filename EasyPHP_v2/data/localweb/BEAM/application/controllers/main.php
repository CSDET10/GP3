...
public function member()
	...
	public function asPermission($destination){
		$usersPermission = array(array("home","performance","band","stage","agent","member"),array("home","performance","agent","band"),array("home","performance","agent","band","member"),array("home","agent","member")); #admin, beam, security officer, security guard
